...
// Global Variable
const grades = [60, 70, 80, 65, 90, 83];
...
function lastTo50() {
  ...
  let lengthlast = grades.length;
  grades[lengthlast - 1] = 50
...
function randomTo100() {
  ...
  let lengthlast = grades.length;
  let randNum = Math.floor(Math.random() * lengthlast);
  grades[randNum] = 100
...
function countBelow50() {
  ...
  outputEl.innerHTML = "Count grades below 50: " + underFifty;
}
